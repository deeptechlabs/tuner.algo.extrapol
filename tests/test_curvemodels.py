# -*- coding: utf-8 -*-
"""
:mod:`orion.algo.extrapol.tests.test_curvemodels` -- Curve Model Test
================================================================================
...
.. Copyright::
    Tobias Domhan (2014)
    Implementation Dendi Suhubdy (2018)
...
from orion.algo.extrapol.curvefunctions import  all_models, model_defaults
from orion.algo.extrapol.curvemodels import CurveModel, MLCurveModel, LinearCurveModel
from orion.algo.extrapol.curvemodels import masked_mean_x_greater_than
